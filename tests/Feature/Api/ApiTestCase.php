...
abstract class ApiTestCase extends TestCase
{
     ...
     */
    protected function authenticatedApiGet(string $endpoint, User $user = null): \Illuminate\Testing\TestResponse
    {
     ...
     */
    protected function authenticatedApiPost(string $endpoint, array $data = [], User $user = null): \Illuminate\Testing\TestResponse
    {
        $this->authenticateUser($user);
     ...
     */
    protected function authenticatedApiPut(string $endpoint, array $data = [], User $user = null): \Illuminate\Testing\TestResponse
    {
        $this->authenticateUser($user);
     ...
     */
    protected function authenticatedApiDelete(string $endpoint, User $user = null): \Illuminate\Testing\TestResponse
    {
        $this->authenticateUser($user);
