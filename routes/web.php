...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('categories')->name('categories.')->group(function () {
        ...
        Route::get('/{category}', Categories\ShowController::class)->name('show');
        ...
        Route::delete('/{category}', Categories\DestroyController::class)->name('destroy');
    });
    ...
    Route::prefix('tasks')->name('tasks.')->group(function () {
        ...
        Route::get('/{task}', Tasks\ShowController::class)->name('show');
        ...
        Route::delete('/{task}', Tasks\DestroyController::class)->name('destroy');
    });
    ...
    Route::prefix('users')->name('users.')->group(function () {
        ...
        Route::get('/{user}', Users\ShowController::class)->name('show');
