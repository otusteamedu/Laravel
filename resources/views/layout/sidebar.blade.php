<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark"> <a href="/"
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item"> <a href="#" class="nav-link active" aria-current="page"> <svg class="bi pe-none me-2"
