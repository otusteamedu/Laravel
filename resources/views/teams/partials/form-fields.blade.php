...
<div>
    ...
    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $team?->name ?? null)"
...
<div>
    ...
    <x-text-input id="nickname" name="nickname" type="text" class="mt-1 block w-full"
        :value="old('nickname', $team?->nickname ?? null)"  required autofocus autocomplete="off" />
