...
class RealEducationRoutePointRepo implements RealEducationRoutePointRepoInterface
{
    /**
    ...
    {
        return RealEducationRoutePoint::where('id', $inputData['id'])->get($inputData['returned_fields'])->toArray();
    }
    ...
    {
        return RealEducationRoutePoint::where('route_id', $inputData['route_id'])->get()->toArray();
    }
    ...
    {
        return RealEducationRoutePoint::all()->toArray();
    }
    ...
    {
        return RealEducationRoutePoint::select('*')
