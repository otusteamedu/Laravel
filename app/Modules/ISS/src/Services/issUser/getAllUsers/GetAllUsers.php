...
use App\Modules\ISS\src\Services\issUser\getAllUsers\InputDTO;
use App\Modules\ISS\src\Services\issUser\getAllUsers\OutputDTO;
...
class GetAllUsers
{
    ...
    public function __invoke(InputDTO $inputData): OutputDTO
    {
        $users = [];
        try {
            $users = $this->repository->getAllUsersData(['returned_fields' => $inputData->returnedFields]);
