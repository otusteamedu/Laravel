...
<div class="col-12 mb-3">
    ...
    <x-todo-app::invalid-feedback :errors="$errors->get('title')"/>
</div>
...
<div class="col-12 mb-3">
    ...
    <x-todo-app::invalid-feedback :errors="$errors->get('description')"/>
</div>
...
<div class="col-12 mb-3">
    ...
    >
    <x-todo-app::invalid-feedback :errors="$errors->get('deadline')"/>
</div>
...
<div class="col-12 mb-3">
    <div class="input-group">
        ...
        >
        <x-todo-app::invalid-feedback :errors="$errors->get('options.video')"/>
    </div>
