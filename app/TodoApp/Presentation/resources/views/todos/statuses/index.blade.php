 ...
 * @var \App\TodoApp\Application\DTOs\TodoStatusDTO[] $statuses
*/
@endphp
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-9">
                    <div class="p-4" id="statuses">
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap">
                                @foreach($statuses as $status)
                                    @include('todo-app::todos.statuses.status-card', [
                                        'projectId' => $project->projectId,
                        ...
                        <div class="mb-4">
                            @include('todo-app::todos.statuses.form', [
                                'projectId' => $project->projectId,
                            ])
                        </div>
                    </div>
...
@include('todo-app::todos.statuses.delete-confirmation', ['projectId' => $project->projectId])
