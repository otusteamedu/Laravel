 ...
 * @var \App\TodoApp\Application\DTOs\ProjectInvitedUserDTO[] $users
 */
@endphp
                            ...
                            <table class="project-user-table table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr id="project-member-list-{{ $user->userId }}">
                                        ...
                                        @can('project.user.manage', $project->projectId)
                                            <td class="d-none d-md-table-cell">{{ \Illuminate\Support\Carbon::parse($user->invited)->translatedFormat("j F Y") }}</td>
                                            <td class="d-none d-md-table-cell">{{ $user->joined ? \Illuminate\Support\Carbon::parse($user->joined)->translatedFormat("j F Y") : '' }}</td>
                                        @endcan
                                    </tr>
                                    @endforeach
                                </tbody>
