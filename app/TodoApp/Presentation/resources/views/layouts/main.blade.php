...
<header class="sticky-top">
    @include('todo-app::navbar.navbar')
</header>
...
<footer>
    @include('todo-app::partials.footer')
</footer>

@if(session('error'))
    <x-todo-app::toast :success=false message="{{ session('error') }}"></x-todo-app::toast>
@endif
@if(session('success'))
    <x-todo-app::toast :success=true message="{{ session('success') }}"></x-todo-app::toast>
@endif
