            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <div class="mb-3 input-group">
                        ...
                        <x-todo-app::invalid-feedback :errors="$errors->updatePassword->get('current_password')"/>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="mb-3 input-group">
                        ...
                        <span class="input-group-text"><i class="fa fa-lock"></i></span>
                        <x-todo-app::invalid-feedback :errors="$errors->updatePassword->get('password')"/>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="mb-3 input-group">
                        <input name="password_confirmation" type="password" 
                            ...
                            placeholder="Введите пароль, который нужно установить" required autocomplete="new-password">
                        <span class="input-group-text"><i class="fa fa-lock"></i></span>
                        <x-todo-app::invalid-feedback :errors="$errors->updatePassword->get('password_confirmation')"/>
                    </div>
                </div>
                <div class="col-12">
